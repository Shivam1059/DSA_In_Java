// WAP to reverse a Stack using a queue??
...
{
   public static void reverse(StackImpl stack,CircularQueue cqueue)
   {
	while(!stack.isEmpty())
	{
   ...
   public static void main(String []args)
   {
	...
	System.out.println("------STACK REVERSE USING QUEUE------");
